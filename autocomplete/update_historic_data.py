...
if __name__ == '__main__':
    ...
    if argv['platform'] == 'app':
        filename = '/nykaa/adminftp/click_ist_app_agg20181211-20190610.csv'
        if not os.path.exists(filename):
            filename = '/nykaa/adminftp/click_ist_app_agg20181211-20190610.zip'

    print(filename)
    read_file(filename, platform=argv['platform'], dryrun=argv['dryrun'], limit=argv['limit'],
